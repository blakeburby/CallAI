export const toolDefinitions = [
  {
    ...
    function: {
      name: "create_task",
      description:
        "Create a remote developer-operator task from the user's spoken request. Use this for repo inspection, edits, tests, Codex delegation, docs updates, bug fixes, and project work.",
      parameters: {
        type: "object",
        properties: {
          utterance: {
